...
function CreateAddress({ handleClose, fetchData }) {
    ...
    const handleSubmit = async () => {
        ...
        const req = await addressService.create(body);
        if (req.status === 201) {
            handleClose();
            fetchData();
        } else {
                ...
                <div className={cx('form-group')}>
                    ...
                    <div className={cx('form-content')}>
                        <div className={cx('form-input')}>
                            <input ref={inputName} type="text" className={cx('form-control')} />
                        </div>
                    </div>
                </div>
                <div className={cx('form-group')}>
                ...
                <div className={cx('form-group')}>
                    ...
                    <div className={cx('form-content')}>
                        <div className={cx('form-input', 'item-checkbox')}>
                            <input ref={inputCheckbox} type="checkbox" className={cx('item-checkbox-input')} />
                        </div>
                    </div>
                </div>
            </div>
